...
public class Pawn extends Piece {
    ...
    public List<List<Integer>> getPossibleMoves(ChessField[][] board, int rf, int cf, Piece pieceLastMoved, int lastRow, int lastCol, boolean is2) {
        ...
        if (color.equals("white") && pieceLastMoved != null && pieceLastMoved.getName() == 'p' && lastCol == cf && (lastRow == rf - 1 || lastRow == rf + 1) && is2) {
        ...
        } else if (color.equals("black") && pieceLastMoved != null && pieceLastMoved.getName() == 'P' && lastCol == cf && (lastRow == rf - 1 || lastRow == rf + 1) && is2) {
            List<Integer> move1 = new ArrayList<>();
            List<Integer> move2 = new ArrayList<>();
            move1.add(cf + 1);
            move1.add(rf - 1);
